 ...
 */
void
bml_multiply_adjust_AB_distributed2d(
    bml_matrix_distributed2d_t * A,
    bml_matrix_distributed2d_t * B,
    bml_matrix_distributed2d_t * C,
    double threshold)
{
    ...
    {
        case single_real:
            bml_multiply_adjust_AB_distributed2d_single_real(A, B, C,
                                                             threshold);
            break;
        case double_real:
            bml_multiply_adjust_AB_distributed2d_double_real(A, B, C,
                                                             threshold);
            break;
        case single_complex:
            bml_multiply_adjust_AB_distributed2d_single_complex(A, B, C,
                                                                threshold);
            break;
        case double_complex:
            bml_multiply_adjust_AB_distributed2d_double_complex(A, B, C,
                                                                threshold);
            break;
        default:
            LOG_ERROR("unknown precision\n");
