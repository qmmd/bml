...
bml_matrix_csr_t * bml_transpose_new_csr_single_real(bml_matrix_csr_t * A);

bml_matrix_csr_t * bml_transpose_new_csr_double_real(bml_matrix_csr_t * A);

bml_matrix_csr_t * bml_transpose_new_csr_single_complex(bml_matrix_csr_t * A);

bml_matrix_csr_t * bml_transpose_new_csr_double_complex(bml_matrix_csr_t * A);
