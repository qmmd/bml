...
configure() {
    ...
    ${CMAKE:=cmake} .. \
        ...
        -DBML_MPI="${BML_MPI}" \
        -DMPIEXEC_EXECUTABLE="${BML_MPIEXEC_EXECUTABLE}" \
        -DMPIEXEC_NUMPROCS_FLAG="${BML_MPIEXEC_NUMPROCS_FLAG}" \
        -DMPIEXEC_PREFLAGS="${BML_MPIEXEC_PREFLAGS}" \
