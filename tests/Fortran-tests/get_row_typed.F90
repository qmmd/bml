module get_row_typed
  ...
  public :: test_get_row_typed

contains

  function test_get_row_typed(matrix_type, element_kind, element_precision,&
  ...
  end function test_get_row_typed

end module get_row_typed
