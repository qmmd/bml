...
# No MPI, yes GPU
CC=gcc FC=gfortran BML_GPU=yes GPU_ARCH=sm_60 CUDA_TOOLKIT_ROOT_DIR=/projects/opt/centos7/cuda/9.0 BLAS_VENDOR=Intel CMAKE_BUILD_TYPE=Release BML_OPENMP=yes CMAKE_INSTALL_PREFIX=/home/smm/bml/bml/install ./build.sh configure
